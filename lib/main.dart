...
import 'features/job/job_category_page.dart';
                ...
                OutlinedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => const JobCategoryPage(),
                      ),
                    );
                  },
                  child: const Text('Job Categories'),
                ),
                const SizedBox(height: 10),
...
class _BadgeText extends StatelessWidget {
  ...
  const _BadgeText({required this.text, required this.count});
